...
<br>
	<form>
		...
		<!--********** EDIT *****************-->
		<b>Ê Ngát, Ngát có tình cảm với tớ không?</b>
		</span>
		</h2>
	...
	<br>
		...
		<!--********** EDIT *****************-->
<b><font color=#037500>Khai thật đi để tớ còn biết mà yêu lại :D ^^</font>
</b>
</div></div>
    </li>
...
<p id="copy" onClick="window.open('https://www.facebook.com/LinhKhanh','')">Liên hệ Tôi
</p>
<script>
var txt="---- Gởi Tặng Em -------------------------";
var espera=100;
